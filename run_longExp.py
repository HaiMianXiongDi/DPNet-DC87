...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage_pool_kernel', type=int, default=2, help='AvgPool1d kernel_size') #3
    parser.add_argument('--stage_pool_stride', type=int, default=2, help='AvgPool1d stride') #2
    parser.add_argument('--stage_pool_padding', type=int, default=1, help='AvgPool1d padding')
    parser.add_argument('--shared_embedding', type=int, default=1, help='stride')
    parser.add_argument('--debug_intermediate', action='store_true',
                    help='debug')
    #=======
    ...
    parser.add_argument(
        '--interp_ratios',
        type=float,
        nargs=2,                     # exactly two values required
        default=[1.0, 1.0],          # default pair
        help='two interpolation ratios, e.g. --interp_ratios 1.5 3.0'
    )
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if args.do_predict:
                print('>>>>>>>predicting : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(args.model_id))
